...
console.log(random_no, quick_draw_data_set[random_no]);
document.getElementById("sketch_to_be_drawn").innerHTML = "Sketch to be drawn : " + quick_draw_data_set[random_no];
...
{
	drawn_sketch = sketch_to_be_drawn;
	timer_counter = timer_counter+1;
    document.getElementById("t").innerHTML = "Timer : " + timer_counter;
...
{ 
    ...
    } else
    {
        ...
        document.getElementById('drawn_sketch').innerHTML = 'Your sketch : ' + results[0].label; 
